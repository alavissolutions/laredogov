...
.filings{list-style:none;margin:.5rem 0;padding:0}
.filings>li{padding:.5rem 0;border-bottom:1px solid var(--line)}
.filings .note{display:block;font-size:.875rem;color:var(--muted)}
