...
export const DIRECTORY_ONLY: readonly DirectoryEntry[] = [
  ...
  { id: 'opengov', publisher: 'city-of-laredo', kind: 'lookup', url: 'https://laredotx.opengov.com/transparency', stringsKey: 'dir.opengov', lastVerified: VERIFIED, hasSearchWith: true },
  ...
  { id: 'municode', publisher: 'city-of-laredo', kind: 'lookup', url: 'https://library.municode.com/tx/laredo/codes/code_of_ordinances', stringsKey: 'dir.municode', lastVerified: VERIFIED, hasSearchWith: true },
  { id: '311', publisher: 'city-of-laredo', kind: 'lookup', url: 'https://www.cityoflaredo.com/services/311-online-services', stringsKey: 'dir.311', lastVerified: VERIFIED, hasSearchWith: true },
  ...
  { id: 'county-tax', publisher: 'webb-county', kind: 'lookup', url: 'https://webb.go2gov.net/', stringsKey: 'dir.county-tax', lastVerified: VERIFIED, hasSearchWith: true },
  { id: 'county-clerk', publisher: 'webb-county', kind: 'lookup', url: 'https://www.webbcountytx.gov/329/Foreclosures', stringsKey: 'dir.county-clerk', lastVerified: VERIFIED, hasSearchWith: true },
  { id: 'county-district-clerk', publisher: 'webb-county', kind: 'lookup', url: 'https://www.webbcountytx.gov/277/District-Clerk', stringsKey: 'dir.county-district-clerk', lastVerified: VERIFIED, hasSearchWith: true },
  { id: 'county-sheriff-jail', publisher: 'webb-county', kind: 'lookup', url: 'http://www.webbcountytx.gov/Sheriff/', stringsKey: 'dir.county-sheriff-jail', lastVerified: VERIFIED, hasSearchWith: true },
  { id: 'cad-property-search', publisher: 'webb-cad', kind: 'lookup', url: 'https://propaccess.webbcad.org/clientdb/?cid=1', stringsKey: 'dir.cad-property-search', lastVerified: VERIFIED, hasSearchWith: true },
  { id: 'cad-online-appeals', publisher: 'webb-cad', kind: 'lookup', url: 'https://onlineappeals.webbcad.org/', stringsKey: 'dir.cad-online-appeals', lastVerified: VERIFIED, hasSearchWith: true },
